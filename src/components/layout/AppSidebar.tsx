          ...
          {!collapsed ? (
            ...
            <Tooltip>
              <TooltipTrigger asChild>
                <div className="w-8 h-8 rounded-full gradient-bg flex items-center justify-center text-white text-xs font-bold mx-auto mb-3 cursor-default">
                  {initials}
                </div>
              </TooltipTrigger>
          ...
          <Tooltip>
            <TooltipTrigger asChild>
              <button
                ...
                className={`flex items-center gap-2 text-sidebar-foreground hover:text-white text-[12px] transition-colors w-full ${collapsed ? "justify-center px-0" : "px-1"}`}
              >
                <LogOut className="h-3.5 w-3.5 shrink-0" />
                {!collapsed && <span>Log out</span>}
              </button>
            </TooltipTrigger>
            {collapsed && <TooltipContent side="right" className="text-xs">Log out</TooltipContent>}
          </Tooltip>
        </div>
      </aside>
    </TooltipProvider>
