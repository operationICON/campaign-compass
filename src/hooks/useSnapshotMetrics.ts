...
export function applySnapshotToLinks(
  ...
  return links.map(l => {
    ...
    return { ...l, _subscribers: l.subscribers, _clicks: l.clicks, _revenue: l.revenue, clicks: m.clicks, subscribers: m.subscribers, revenue: m.revenue, snapshotDays: m.days, snapshotHasData: m.hasData };
  });
}
